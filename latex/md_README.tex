...
\hypertarget{md_README}{}\label{md_README}\index{YAML Toolkit@{YAML Toolkit}}
\label{md_README_autotoc_md0}%
\Hypertarget{md_README_autotoc_md0}%
 Provides robust YAML validation and file handling services for Drupal applications.\hypertarget{md_README_autotoc_md1}{}\doxysection{\texorpdfstring{Table of contents}{Table of contents}}\label{md_README_autotoc_md1}
...
Install as you would normally install a contributed Drupal module. For further information, see \href{https://www.drupal.org/docs/extending-drupal/installing-drupal-modules}{\texttt{ Installing Drupal Modules}}.\hypertarget{md_README_autotoc_md4}{}\doxysubsection{\texorpdfstring{Via Composer (recommended)}{Via Composer (recommended)}}\label{md_README_autotoc_md4}

\begin{DoxyCode}{0}
\DoxyCodeLine{composer\ require\ drupal/yaml\_toolkit}

\end{DoxyCode}
\hypertarget{md_README_autotoc_md5}{}\doxysubsection{\texorpdfstring{Manual installation}{Manual installation}}\label{md_README_autotoc_md5}
...
\end{DoxyEnumerate}\hypertarget{md_README_autotoc_md6}{}\doxysection{\texorpdfstring{Configuration}{Configuration}}\label{md_README_autotoc_md6}
No configuration is required. The module provides services that can be injected into your custom code.\hypertarget{md_README_autotoc_md7}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_README_autotoc_md7}
\hypertarget{md_README_autotoc_md8}{}\doxysubsection{\texorpdfstring{Basic YAML validation}{Basic YAML validation}}\label{md_README_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md9}{}\doxysubsection{\texorpdfstring{File operations}{File operations}}\label{md_README_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md10}{}\doxysection{\texorpdfstring{Services}{Services}}\label{md_README_autotoc_md10}
\hypertarget{md_README_autotoc_md11}{}\doxysubsection{\texorpdfstring{yaml\+\_\+toolkit.\+validator}{yaml\_toolkit.validator}}\label{md_README_autotoc_md11}
...
{\bfseries{Service ID}}\+: {\ttfamily yaml\+\_\+toolkit.\+validator} ~\newline
 ...
 {\bfseries{Class}}\+: {\ttfamily Drupal\textbackslash{}yaml\+\_\+toolkit\textbackslash{}Service\textbackslash{}Yaml\+Validator}\hypertarget{md_README_autotoc_md12}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{md_README_autotoc_md12}

\begin{DoxyItemize}
\item {\ttfamily check\+Yaml(\$data)}\+: Validates YAML content
\item {\ttfamily get\+Result()}\+: Returns detailed validation information
\end{DoxyItemize}\hypertarget{md_README_autotoc_md13}{}\doxysubsection{\texorpdfstring{yaml\+\_\+toolkit.\+storage}{yaml\_toolkit.storage}}\label{md_README_autotoc_md13}
...
{\bfseries{Service ID}}\+: {\ttfamily yaml\+\_\+toolkit.\+storage} ~\newline
 ...
 {\bfseries{Class}}\+: {\ttfamily Drupal\textbackslash{}yaml\+\_\+toolkit\textbackslash{}Service\textbackslash{}Yaml\+Storage}\hypertarget{md_README_autotoc_md14}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{md_README_autotoc_md14}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md15}{}\doxysection{\texorpdfstring{API}{API}}\label{md_README_autotoc_md15}
\hypertarget{md_README_autotoc_md16}{}\doxysubsection{\texorpdfstring{Yaml\+Validator\+Interface}{YamlValidatorInterface}}\label{md_README_autotoc_md16}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md17}{}\doxysubsection{\texorpdfstring{Yaml\+Storage\+Interface}{YamlStorageInterface}}\label{md_README_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md18}{}\doxysubsection{\texorpdfstring{Error codes}{Error codes}}\label{md_README_autotoc_md18}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md19}{}\doxysection{\texorpdfstring{Troubleshooting}{Troubleshooting}}\label{md_README_autotoc_md19}
\hypertarget{md_README_autotoc_md20}{}\doxysubsection{\texorpdfstring{Common issues}{Common issues}}\label{md_README_autotoc_md20}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md21}{}\doxysubsection{\texorpdfstring{Debugging}{Debugging}}\label{md_README_autotoc_md21}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md22}{}\doxysection{\texorpdfstring{Maintainers}{Maintainers}}\label{md_README_autotoc_md22}
